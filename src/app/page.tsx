...
async function exAllData(currentSection: string) {
...
export default async function Home() {
    const homeSectionData = await exAllData("home");
    const aboutSectionData = await exAllData("about");
    const experienceSectionData = await exAllData("experience");
    const educationSectionData = await exAllData("education");
    const projectsSectionData = await exAllData("projects");
